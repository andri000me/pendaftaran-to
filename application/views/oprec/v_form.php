        ...
        <div class="wrapper wrapper--w1000">
            <div class="card card-5">
                <div class="card-heading">
                    <h4 class="title">REGISTRASI TRYOUT ONLINE<br>FORUM SHARE FILE & TANYA JAWAB</h4>
                </div>
						...
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="nama_depan" id="nama_depan"  placeholder="Contoh: Fajar Rivaldi Chan " class="span5" onKeyPress="return goodchars(event,' abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.\',',this)" required>
                                </div>
                            </div>
                        </div>
						<div class="form-row">
						...
						<div class="form-row m-b-55">
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="nama_belakang" id="nama_belakang"  placeholder="Contoh: Medan" class="span5" onKeyPress="return goodchars(event,' abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.\',',this)" required>
                                            <label class="label--desc">Daerah</label>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="asal_sekolah" id="asal_sekolah" placeholder="Contoh: Fasilkom Universitas Indonesia" class="span5" required>
                         ...
                         <div class="form-row">
                            <div class="name">NO HP/WA</div>
								<div class="value">
										<div class="input-group">
                                            <input class="input--style-5" type="number" name="nohp" id="nohp"  placeholder="Contoh: 0895611024559" class="span5" onKeyPress="return goodchars(event,'0123456789',this)" required> 
                                        </div>
                                  </div>
                            </div>
						<div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="instagram" id="instagram"  placeholder="Contoh: @fajar.chaniago_" class="span5" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        ...
                                        <label class="label--desc-1">*Upload Foto dirimu. latar  bebas, Ukuran Gambar max 2MB. Format gbr jpg, jpeg atau png.</small></label>
                                        <div class="select-dropdown"></div>
                                    </div>
                                </div>
                            </div>
                ...
                <br>
                 <div class="form-row-1">
						...
						<div class="form-row ">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="email"  name="email" id="email" maxlength="100" minlength="5" placeholder="Contoh: fajarrivaldi2015@gmail.com" class="span5" required>
